...
bias = np.array([away_win_rate, tie_rate, home_win_rate])
...
df_team[
    ['away_rank_standard', 'tie_rank_standard', 'home_rank_standard']
] = mean_ranks_standard
...
df_elo_2024.rename(
    columns={c: 'matchday_0_' + c for c in df_elo_2024.columns},
    inplace=True
)
